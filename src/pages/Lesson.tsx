...
import { markLessonComplete, getUserProgress, getWeeksWithLessons, getCourse } from "@/lib/supabase-helpers";
...
export default function Lesson() {
  ...
  const loadLesson = async () => {
    ...
    const ordered = weeks.flatMap(w => w.lessons);
  ...
  const handleMarkComplete = async () => {
    ...
    // Check if all lessons complete → generate certificate
